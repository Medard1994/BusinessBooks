...
const EditBooks = () => {
  ...
  return (
    <div className="ml-56 flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 sm:p-8 md:p-10 lg:p-12 xl:p-14 rounded-lg shadow-md w-full max-w-5xl">
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-6" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col">
            ...
            <TextInput
              ...
              required
              className="border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-cyan-600 w-full sm:w-[400px] lg:w-full"
            />
          </div>
